...
namespace Microsoft.Toolkit.Uwp.Input.GazeInteraction
{
    ...
    public sealed class GazePointer
    {
        ...
        private static readonly TimeSpan DEFAULT_FIXATION_DELAY = TimeSpan.FromSeconds(0.350);
        private static readonly TimeSpan DEFAULT_DWELL_DELAY = TimeSpan.FromSeconds(0.400);
        private static readonly TimeSpan DEFAULT_DWELL_REPEAT_DELAY = TimeSpan.FromSeconds(0.400);
        private static readonly TimeSpan DEFAULT_REPEAT_DELAY = TimeSpan.FromSeconds(0.400);
        private static readonly TimeSpan DEFAULT_THRESHOLD_DELAY = TimeSpan.FromSeconds(0.050);
        private static readonly TimeSpan DEFAULT_MAX_HISTORY_DURATION = TimeSpan.FromSeconds(3);
        private static readonly TimeSpan MAX_SINGLE_SAMPLE_DURATION = TimeSpan.FromSeconds(0.100);

        private static readonly TimeSpan GAZE_IDLE_TIME = TimeSpan.FromSeconds(0.250);
        /*
    public:
    virtual ~GazePointer();
        ...
        /// </summary>
        public void LoadSettings(ValueSet settings) { throw new NotImplementedException(); }
...
private:
    ...
    internal:
    */
        internal Brush EnterBrush { get; set; }
        ...
        /*
            ...
            internal:
            */
        internal static GazePointer Instance { get { throw new NotImplementedException(); } }

        /*
        EventRegistrationToken _unloadedToken;
        */
        internal void AddRoot(int proxyId) { throw new NotImplementedException(); }

        internal void RemoveRoot(int proxyId) { throw new NotImplementedException(); }
