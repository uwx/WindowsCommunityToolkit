...
namespace Microsoft.Toolkit.Uwp.Input.GazeInteraction
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether the application should set this value to true to prevent invoking the control when the user dwells on a control
        /// </summary>
