...
{
    var element = safe_cast<FrameworkElement>(ob);
    var interaction = safe_cast<Interaction>(args.NewValue);
...
static DependencyProperty s_cursorRadiusProperty = DependencyProperty.RegisterAttached("CursorRadius", int.typeid, GazeInput.typeid,
    new PropertyMetadata(6, new PropertyChangedCallback(&OnCursorRadiusChanged)));
static DependencyProperty s_gazeElementProperty = DependencyProperty.RegisterAttached("GazeElement", GazeElement.typeid, GazeInput.typeid, new PropertyMetadata(null));
static DependencyProperty s_fixationDurationProperty = DependencyProperty.RegisterAttached("FixationDuration", TimeSpan.typeid, GazeInput.typeid, new PropertyMetadata(GazeInput.UnsetTimeSpan));
static DependencyProperty s_dwellDurationProperty = DependencyProperty.RegisterAttached("DwellDuration", TimeSpan.typeid, GazeInput.typeid, new PropertyMetadata(GazeInput.UnsetTimeSpan));
static DependencyProperty s_repeatDelayDurationProperty = DependencyProperty.RegisterAttached("RepeatDelayDuration", TimeSpan.typeid, GazeInput.typeid, new PropertyMetadata(GazeInput.UnsetTimeSpan));
static DependencyProperty s_dwellRepeatDurationProperty = DependencyProperty.RegisterAttached("DwellRepeatDuration", TimeSpan.typeid, GazeInput.typeid, new PropertyMetadata(GazeInput.UnsetTimeSpan));
static DependencyProperty s_thresholdDurationProperty = DependencyProperty.RegisterAttached("ThresholdDuration", TimeSpan.typeid, GazeInput.typeid, new PropertyMetadata(GazeInput.UnsetTimeSpan));
static DependencyProperty s_maxRepeatCountProperty = DependencyProperty.RegisterAttached("MaxDwellRepeatCount", int.typeid, GazeInput.typeid, new PropertyMetadata(safe_cast<Object>(0)));
